...
![Screenshot 2023-12-16 163020](https://github.com/ezhilnevedha/Ex.-No.-8.-PROTOTYPE-PART-MODEL-DESIGN-IN-3D-PRINTER/assets/140057992/8f777edd-6232-46ac-ba94-83ac441059de)
### Step 3:- select the Pan option and select the extruder (left of right) for printing the design and then after select the Repair option for auto correction of design of software parameter as shown in below figure.

![Screenshot 2023-12-16 162546](https://github.com/ezhilnevedha/Ex.-No.-8.-PROTOTYPE-PART-MODEL-DESIGN-IN-3D-PRINTER/assets/140057992/c4b1bddb-5677-4c5e-a640-450d0ed6f041)
### Step 4.:- select the Move option for design print position in build tack plate and then after select the Rotate option for rotate the design easily printed and used low print material as shown in below figure.

![Screenshot 2023-12-16 162626](https://github.com/ezhilnevedha/Ex.-No.-8.-PROTOTYPE-PART-MODEL-DESIGN-IN-3D-PRINTER/assets/140057992/5ace22a2-16be-40e3-8d84-999baef8b6fb)
### Step 5.:- select the Scale option for design scale according to build plate area and then after click the start option and select printing option standard as shown in below figure.

![Screenshot 2023-12-16 162649](https://github.com/ezhilnevedha/Ex.-No.-8.-PROTOTYPE-PART-MODEL-DESIGN-IN-3D-PRINTER/assets/140057992/1eeb63e0-22e3-433c-a5a8-769b19fbfcdb)
### Step 6.:- After completing all settings then click the Slice option and export the file in gcode format.

![Screenshot 2023-12-16 162822](https://github.com/ezhilnevedha/Ex.-No.-8.-PROTOTYPE-PART-MODEL-DESIGN-IN-3D-PRINTER/assets/140057992/e1c4f992-efd4-4b6f-9f2d-05b85ac753f5)

![Screenshot 2023-12-16 162840](https://github.com/ezhilnevedha/Ex.-No.-8.-PROTOTYPE-PART-MODEL-DESIGN-IN-3D-PRINTER/assets/140057992/b37dcca9-3c39-4c96-8ce1-81f8e081e4d9)
### Step 7.:- After generating the gcode format then follow the these instruction as shown in below figure.
###   1.	Switch on the 3d printer.
###   2.	Place your Pen drive in USB.
###   3.	Clean the surface bed plate.
